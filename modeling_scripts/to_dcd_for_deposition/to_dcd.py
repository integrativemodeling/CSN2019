...
# Adapted for the deposition of the Cop9 signalosome study
# by Ilan E. Chemmama in Andrej Sali lab
...
import ast
import sys
#sys.path.append('/opt/chimera-1.13.1-1.fc29/share/Trajectory/DCD/MDToolsMarch97/')
