...
for m, info in models.items():
    ...
    centroid = fix_rmf_file(
        '../IntegrativeStructure.CSNn/Structure_DSSO_DHSO_BMSO/cluster_center_model.rmf3',
        moldict,
        tmpd)
    ...
    for asym in po.asym_units:
        name = asym.split('.')[0]
        fname = '../IntegrativeStructure.CSNn/Structure_DSSO_DHSO_BMSO/DSSO_DHSO_BMSO.'+name+'.LPD.mrc'
        print('fname', fname)
