...
runCommand('volume #'+str(i)+' step 1 transparency 0.70 encloseVolume ' + str(precision[suffix] * totvol))
i+=1    
...
for p in prots:
    ...
    runCommand('volume #'+str(i)+' encloseVolume '+str(precision[suffix]*vol[p])+' step 1 transparency 0.70')
